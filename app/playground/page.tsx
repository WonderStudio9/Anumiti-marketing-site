            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-2">
                {endpoints.map((ep, index) => (
                  <ScrollReveal key={ep.path} delay={index * 0.08}>
                    <button
                      disabled
                      className="w-full rounded-lg border border-gray-200 bg-white p-3 text-left transition-all duration-300 hover:-translate-y-1 hover:border-gray-300 hover:shadow-xl disabled:opacity-60 disabled:cursor-not-allowed"
                    >
