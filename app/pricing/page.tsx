  ...
  return (
    <>
      ...
      <Section background="gray">
        ...
        {/* Bundle banner */}
        {activeTab === "bundle" && (
          <div className="mb-10 flex items-center justify-center gap-3 rounded-xl bg-teal-50 p-4 text-center">
        ...
        {activeTab === "bundle" ? (
          <div className="space-y-16">
            <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                {bundle.kavach.map((tier) => (
                  <PricingCard key={`kavach-${tier.name}`} tier={tier} product="kavach" />
                ))}
              </div>
            </div>
            <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                {bundle.netra.map((tier) => (
                  <PricingCard key={`netra-${tier.name}`} tier={tier} product="netra" />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            {(activeTab === "kavach" ? KAVACH_PRICING : NETRA_PRICING).map((tier) => (
              <PricingCard key={tier.name} tier={tier} product={activeTab} />
            ))}
          </div>
        )}
      </Section>
