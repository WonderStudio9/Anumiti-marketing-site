...
export default function ContactPage() {
  return (
    <>
        ...
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <ScrollReveal direction="right" delay={0.15} className="lg:col-span-2">
            <div className="sticky top-32 space-y-8">
              {/* Email */}
              <div className="group rounded-2xl border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-teal/30 hover:shadow-lg hover:shadow-teal/5">
                <div className="mb-3 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-teal-50 transition-colors duration-300 group-hover:bg-teal-100">
                ...
                <a
                  ...
                  className="text-sm text-teal transition-colors duration-200 hover:text-teal-800 hover:underline"
                >
                  hello@anumiti.com
                </a>
              ...
              <div className="group rounded-2xl border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-teal/30 hover:shadow-lg hover:shadow-teal/5">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    <a
                      href={CTA_URLS.docs}
                      className="text-teal transition-colors duration-200 hover:text-teal-800 hover:underline"
                    >
                      API Documentation
                    </a>
                  </li>
      ...
      {/* FAQ */}
      <Section background="white" id="faq" className="py-24 md:py-32">
        <ScrollReveal>
